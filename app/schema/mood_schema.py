...
class MoodResponse(BaseModel):
    ...
    confidence_score: float = Field(default=0.85, ge=0, le=1, description="The confidence level of the mood detection")
    llm_provider: str = Field(default="ollama", description="The LLM provider used for analysis")
